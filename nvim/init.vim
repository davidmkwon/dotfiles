...
lspconfig.rust_analyzer.setup {
  ...
  settings = {
    ["rust-analyzer"] = {
      diagnostics = {
        enable = true,
        -- ignore annoying bug with nalgebra::Point
...
-- make the diagnostic messages not inlined but on hover
...
" nmap <leader>ee :<C-u>CocList diagnostics<cr>
